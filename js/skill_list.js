...
// Skill Abilities
    ...
    [DI_TR, OFF, PAT, DEB, WEA, "Sabotage", "-Primary Armor +PVE Damage Reduce", [70, 90, 130, 160, 190] ], 
    ...
    [ES_AR, DEF, ASK, BUF, SEL, "Misdirection", "+All Armor +Resist", [81, 111, 141, 171] ], 
...
// Mutation Abilities
    ...
    [EMPAT, SUP, ASK, CUR, SFR, "Preservation", "-Effect (but _not_ snare)", [54, 72, 90, 108, 126, 144, 162, 180] ], 
    ...
    [ILLUM, SUP, AUR, BUF, TEA, "Meditation", "+Regen Stamina & Gamma (3-19) +Mutation/HW/Grenade damage", [48, 66, 84, 102, 120, 138, 156, 174, 192] ], 
...
/*
     FILE ARCHIVED ON 08:41:51 Mar 22, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:04:20 Mar 24, 2019.
...
/*
playback timings (ms):
  LoadShardBlock: 64.02 (3)
  esindex: 0.005
  captures_list: 82.423
  CDXLines.iter: 12.819 (3)
  PetaboxLoader3.datanode: 116.621 (5)
  exclusion.robots: 0.259
  exclusion.robots.policy: 0.242
  RedisCDXSource: 1.927
  PetaboxLoader3.resolve: 48.295 (2)
  load_resource: 127.907
*/