...
<html lang="en">
  <head>
    <title>Wayback Machine</title>
        ...
        <script src="//archive.org/includes/analytics.js?v=1abda38" type="text/javascript"></script>
        ...
        <script src="//archive.org/includes/build/js/archive.min.js?v=1abda38" type="text/javascript"></script>
        <link href="//archive.org/includes/build/css/archive.min.css?v=1abda38" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript">if('archive_analytics' in window){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app12.us.archive.org';v.server_ms=297;archive_analytics.send_pageview_on_load()}</script>
    ...
    >
      ...
      <span>Search archived web sites</span>
        ...
        >Advanced Search</a>
                              ...
                              <script>AJS.cgi_args = {"ands":[],"minday":"06/04/2009","maxday":"03/24/2019"}</script>
...
<div id="searchHome">
		...
		<input type="text" name="url" value="http://planer.fallen-earth.ru/sorttable.js" size="40" onfocus="javascript:this.focus();this.select();" >
...
<p>The Wayback Machine has not archived that URL.</p>
    ...
    <p>Click here to search for all archived pages under
      <a href="https://web.archive.org/web/*/http://planer.fallen-earth.ru/*">http://planer.fallen-earth.ru/</a>.
    </p>
</div>
	  </div>
	</div>
